    ...
    while True:
        ...
        if "wake up" in query:
            ...
            while True:
                ...
                ############################################################
                ...
                elif "I am exhausted jarvis" in query:
                    speak("you can take some rest or can tell me if i can help you with something, sir")
                    ...
                    b = random.choice(a)
                    if b==1:
                        webbrowser.open("https://youtu.be/syFZfO_wfMQ?si=I4L9zvxZUMrXGPuJ")
